...
const LANGUAGE_OUTPUT_POLICY =
  "Write all player-facing prose in ${language}. Keep JSON keys, schema enum values, identifiers, and game tokens exactly as requested.";

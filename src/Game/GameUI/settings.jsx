...
const LanguageSelector = ({ language, onLanguageChange }) => (
    ...
    <select
    value={normalizeGameLanguage(language)}
    ...
    <div style={helperStyle}>
    Prompts, Apple harness requests, advisor text, diplomacy, and generated events use this language.
    </div>
    </div>
);
    ...
    const checkAppleStatus = async () => {
        ...
        try {
            await callAppleFoundation(
                "You are a readiness probe for SwiftHistoria. Reply with exactly: ready",

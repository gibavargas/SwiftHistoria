...
import { GAME_LANGUAGE_OPTIONS, normalizeGameLanguage } from "../../runtime/languages.js";
...
const LanguageSelect = ({ onChange, value }) => (
  <select style={inputStyle} value={normalizeGameLanguage(value)} onChange={(event) => onChange(event.target.value)}>
...
const buildScenarioEditorState = (details) => {
  ...
  return {
    ...
    language: normalizeGameLanguage(game.language ?? world.language),
    name: scenario.name ?? "",
    prompts,
        ...
        <div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "18px", marginBottom: "0.95rem", padding: "0.9rem" }}>
          <div style={{ display: "grid", gap: "0.8rem", gridTemplateColumns: "repeat(2, minmax(0, 1fr))" }}>
            ...
            <div>
              ...
              <LanguageSelect value={formState.language} onChange={(value) => onChange("language", value)} />
            </div>
            <div>
...
const LibraryTopBar = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const language = normalizeGameLanguage(editorState.language);
      ...
      >
        <div style={{ alignItems: "center", display: "flex", gap: "0.8rem", minWidth: 0 }}>
          <div style={{ alignItems: "center", background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "999px", display: "flex", height: "2.65rem", justifyContent: "center", overflow: "hidden", width: "2.65rem" }}>
            <img alt="SwiftHistoria" src="./logo.png" style={{ height: "1.7rem", width: "1.7rem" }} />
          </div>
          <div style={{ minWidth: 0 }}>
